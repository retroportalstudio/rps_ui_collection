...
import 'package:rps_ui_e1/BorderIcon.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: sidePadding,
                child: Text("Housing Information",style: themeData.textTheme.headline4,),
              ),
              addVerticalSpace(padding),
              ...
              Padding(
                padding: sidePadding,
                child: Text("Loved this design because of it's cleanliness and UX. Everything looks on point. Informative and intuitive enough for audiences of all age groups.The typeface is also aptWhat do you think about this design? \n\n Let us know in the comments below Tag designers and inspire them to create something awesome. Turn on post notifications to never miss a design feed from us"
